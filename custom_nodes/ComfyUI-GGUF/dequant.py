...
dequantize_functions = {
    gr.GGMLQuantizationType.BF16: dequantize_blocks_BF16,
    gr.GGMLQuantizationType.Q8_0: dequantize_blocks_Q8_0,
    gr.GGMLQuantizationType.Q5_1: dequantize_blocks_Q5_1,
    gr.GGMLQuantizationType.Q5_0: dequantize_blocks_Q5_0,
    gr.GGMLQuantizationType.Q4_1: dequantize_blocks_Q4_1,
    gr.GGMLQuantizationType.Q4_0: dequantize_blocks_Q4_0,
    gr.GGMLQuantizationType.Q6_K: dequantize_blocks_Q6_K,
    gr.GGMLQuantizationType.Q5_K: dequantize_blocks_Q5_K,
    gr.GGMLQuantizationType.Q4_K: dequantize_blocks_Q4_K,
    gr.GGMLQuantizationType.Q3_K: dequantize_blocks_Q3_K,
    gr.GGMLQuantizationType.Q2_K: dequantize_blocks_Q2_K,
}
